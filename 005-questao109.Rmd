...
Com a corrente de entrada, tensão na fonte e impedâncias do circuito, é possível agora calcular a tensão na fonte (pelo lado primário) por meio das Tensões de Kirchhoff.
